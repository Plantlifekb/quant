...
CSV_PATH = r"C:\Quant\data\ingestion\ingestion_5years.csv"
...
def main():
    ...
    with get_connection() as conn, conn.cursor() as cur, open(CSV_PATH, newline="", encoding="utf-8") as f:
